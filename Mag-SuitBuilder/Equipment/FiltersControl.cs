...
namespace Mag_SuitBuilder.Equipment
{
	public partial class FiltersControl : UserControl
	{
		...
		void ConfigureFilterFieldLimits()
		{
			const int armorWidth = 48;

			FilterFieldLimits.ConfigureNumericTextBox(txtMinimumBaseArmorLevel, FilterFieldLimits.ArmorLevelMaxLength, armorWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaximumBaseArmorLevel, FilterFieldLimits.ArmorLevelMaxLength, armorWidth);
			txtMaximumBaseArmorLevel.Text = FilterFieldLimits.DefaultMaxArmorLevel;

			FilterFieldLimits.ConfigureNumericTextBox(txtMinimumExtremityArmorLevel, FilterFieldLimits.ArmorLevelMaxLength, armorWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaximumExtremityArmorLevel, FilterFieldLimits.ArmorLevelMaxLength, armorWidth);
			txtMaximumExtremityArmorLevel.Text = FilterFieldLimits.DefaultMaxArmorLevel;

			FilterFieldLimits.ConfigureNumericTextBox(txtWieldRequirementLevelMin, FilterFieldLimits.WieldMaxLength, armorWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtWieldRequirementLevelMax, FilterFieldLimits.WieldMaxLength, armorWidth);
			txtWieldRequirementLevelMax.Text = FilterFieldLimits.DefaultMaxWield;

			FilterFieldLimits.ConfigureNumericTextBox(txtWieldRequirementSkillMin, FilterFieldLimits.WieldMaxLength, armorWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtWieldRequirementSkillMax, FilterFieldLimits.WieldMaxLength, armorWidth);
			txtWieldRequirementSkillMax.Text = FilterFieldLimits.DefaultMaxWield;

			const int quantityWidth = 32;
			FilterFieldLimits.ConfigureNumericTextBox(txtMinLegendaries, FilterFieldLimits.QuantityMaxLength, quantityWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaxLegendaries, FilterFieldLimits.QuantityMaxLength, quantityWidth);
			txtMaxLegendaries.Text = FilterFieldLimits.DefaultMaxQuantity;

			FilterFieldLimits.ConfigureNumericTextBox(txtMinEpics, FilterFieldLimits.QuantityMaxLength, quantityWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaxEpics, FilterFieldLimits.QuantityMaxLength, quantityWidth);
			txtMaxEpics.Text = FilterFieldLimits.DefaultMaxQuantity;

			const int ratingWidth = 36;
			FilterFieldLimits.ConfigureNumericTextBox(txtMinOffensiveRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaxOffensiveRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			txtMaxOffensiveRating.Text = FilterFieldLimits.DefaultMaxRating;

			FilterFieldLimits.ConfigureNumericTextBox(txtMinDefensiveRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaxDefensiveRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			txtMaxDefensiveRating.Text = FilterFieldLimits.DefaultMaxRating;

			FilterFieldLimits.ConfigureNumericTextBox(txtMinOtherRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaxOtherRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			txtMaxOtherRating.Text = FilterFieldLimits.DefaultMaxRating;

			FilterFieldLimits.ConfigureNumericTextBox(txtMinTotalRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			FilterFieldLimits.ConfigureNumericTextBox(txtMaxTotalRating, FilterFieldLimits.RatingMaxLength, ratingWidth);
			txtMaxTotalRating.Text = FilterFieldLimits.DefaultMaxRating;
		}
